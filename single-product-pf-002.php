    ...
    <div class="container">
      <div class="">
        <div class="d-flex">
          ...
          <div class="category-info col-6 justify-content-center">
            <h2 class="category-info-h2">BANANA Pulloverhoody PF-002</h2>
            <h3 class="mt-4">¥5,500<span class="category-info-span">（税込）</span></h3>
            <p class="mt-4">カラーを選択して下さい</p>
            <p id="text mt-4">ブルー</p>
            <div class="d-flex mt-4">
              <img src="<?php echo get_template_directory_uri(); ?>/images/a96524db076b5d948304440e6008dcb0.jpg" alt="ブルー" id="category-img-1" height="100" width="100">
        ...
        <div class="article-div2">
          <div class="fuu section">
            ...
            <div class="euu section">
              <img src="<?php echo get_template_directory_uri(); ?>/images/single-size-3_img.png" alt="サイズ表３" height="420" width="475" style="margin-top: 50px;">
            </div>
          </div>
