        ...
        <div class="d-flex">
          ...
          <div class="category-info col-6 justify-content-center">
            ...
            <div class="d-flex mt-4">
              <img src="<?php bloginfo('template_url'); ?>/images/a96524db076b5d948304440e6008dcb0.jpg" alt="ブルー" id="category-img-1" height="100" width="100">
        ...
        <div class="article-div2">
          <div class="fuu section">
            ...
            <div class="euu section">
              <img src="<?php bloginfo('template_url'); ?>/images/single-size-3_img.png" alt="サイズ表３" height="420" width="475" style="margin-top: 50px;">
            </div>
          </div>
