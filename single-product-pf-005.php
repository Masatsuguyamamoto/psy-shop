      ...
      <div class="">
        <div class="d-flex">
          ...
          <div class="category-info col-6 ">
            <h2 class="category-info-h2">BANANA Tshirt PF-005</h2>
            <h3 class="mt-4">¥3,000 <span class="category-info-span">（税込）</span></h3>
            <p class="mt-4">カラーを選択して下さい</p>
            <p id="text mt-4">ミントブルー</p>
            <div class="d-flex mt-4">
              <img src="<?php echo get_template_directory_uri(); ?>/images/1fae8dbe522cdee6755d687cc902b138-scaled.jpg" alt="ミントブルー" class="ml-3" height="100" width="100">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="container">
          <div class="row">
            <div class="">
              <p class="">商品番号<span class="">: PF-005</span></p>
