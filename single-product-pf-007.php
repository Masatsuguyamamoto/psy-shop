        ...
        <div class="d-flex">
          ...
          <div class="category-info col-6 ">
            ...
            <div class="d-flex mt-4">
              <img src="<?php echo get_template_directory_uri(); ?>/images/fb8aabc0e9e9a2d6e643276d058ab9ef.jpg
" alt="ブラック" id="category-img-1" height="100" width="100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/bb56ef02a276d60336148cb839723901.jpg" alt="ホワイト" class="ml-3" height="100" width="100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/0149bf2eb3be2cb22765be8b15438421.jpg" alt="ミントブルー" class="ml-3" height="100" width="100">
