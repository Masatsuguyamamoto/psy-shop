      ...
      <div class="">
        <div class="d-flex">
          ...
          <div class="category-info col-5 ">
            <h2 class="category-info-h2">Welding Tshirt　PF-010</h2>
            <h3 class="mt-4">¥3,500<span class="category-info-span">（税込）</span></h3>
            <p class="mt-4">カラーを選択して下さい</p>
            <p id="text mt-4">ブラック</p>
            <div class="d-flex mt-4">
              <img src="<?php echo get_template_directory_uri(); ?>/images/2431df87873910c6d4710151e2696b9f.jpg" alt="ブラック" id="category-img-1" height="100" width="100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/7bc87f22a9106a6d39e44eb6a5e83fa5.jpg" alt="ホワイト" class="ml-3" height="100" width="100">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="container">
          <div class="row">
            <div class="">
              <p class="">商品番号<span class="">: PF-010</span></p>
